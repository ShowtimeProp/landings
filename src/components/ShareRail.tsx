...
export default function ShareRail({
  ...
  return (
    <div className="pointer-events-auto fixed left-0 z-[70] max-sm:bottom-24 max-sm:top-auto max-sm:translate-y-0 sm:top-[clamp(14.5rem,25vh,19rem)] sm:-translate-y-1/2">
